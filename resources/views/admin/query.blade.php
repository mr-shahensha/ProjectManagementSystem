                            ...
                            <form method="post" action="{{ url('querySubmit') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control" id="consultant" name="consultant" value=""
                                            placeholder="Type Here">
                                        <span style="color:red;">
                                            @error('consultant')
                                                {{ $message }}
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control" id="custNm" name="custNm" value=""
                                            placeholder="Type Here">
                                        <span style="color:red;">
                                            @error('custNm')
                                                {{ $message }}
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control" id="custNo" name="custNo" value=""
                                            placeholder="Type Here">
                                        <span style="color:red;">
                                            @error('custNo')
                                                {{ $message }}
                                    ...
                                    <br>
                                        ...
                                        <input type="date" class="form-control" id="dt" name="dt" value="<?php echo date('Y-m-d');?>"
                                            placeholder="Type Here">
                                        <span style="color:red;">
                                            @error('dt')
                                                {{ $message }}
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control" id="projectTyp" name="projectTyp" value=""
                                            placeholder="Type Here">
                                        <span style="color:red;">
                                            @error('projectTyp')
                                                {{ $message }}
