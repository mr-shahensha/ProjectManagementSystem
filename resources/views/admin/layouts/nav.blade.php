...
<li class="nav-item active">
    ...
    <div class="sidebar-card d-none d-lg-flex">
        <p class="text-center mb-2"><strong>Latest Message</strong></p>
        <img class="sidebar-card-illustration mb-2" src="{{ url('/admin/img/undraw_rocket.svg') }}" alt="...">
        <p class="text-center mb-2"><strong>SB Admin Pro</strong> Lorem ipsum dolor sit amet consectetur, adipisicing
            elit. Harum, vero</p>
        <a class="btn btn-success btn-sm" href="">Hey There!</a>
    </div>
